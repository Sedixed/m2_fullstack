 ...
 */
class getDelivererRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DelivererRepository' shared autowired service.
     *
     * @return \App\Repository\DelivererRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DelivererRepository.php';

        return $container->privates['App\\Repository\\DelivererRepository'] = new \App\Repository\DelivererRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
